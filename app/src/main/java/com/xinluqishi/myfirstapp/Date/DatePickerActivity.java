...
import com.tbi.app.tbishop.IConst;
import com.tbi.app.tbishop.constant.DatePickerEnum;
import com.tbi.app.tbishop.core.TbiAppActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            if (!isEndDateInput) {
                ...
                if (Validator.isNotEmpty(startDateStr)) {
                    datePickerFragment.setStartDateValue(startDateStr);
                    if (Validator.isNotEmpty(endDateStr)) {
