...
//                        Bundle bundle = new Bundle();
//                        bundle.putString(IConst.Bundle.SELECTDATE_END_DATE, endDateStr);
//                        bundle.putInt(IConst.Bundle.WIN_RESULT, IConst.Bundle.WIN_SELECT_DATE);
//                        Intent intent = new Intent();
//                        intent.putExtras(bundle);
//
//                        getActivity().setResult(Activity.RESULT_OK, intent);
...
//                bundle.putString(IConst.Bundle.SELECTDATE_START_DATE, startDateStr);
//                bundle.putString(IConst.Bundle.SELECTDATE_END_DATE, endDateStr);
//                bundle.putString(IConst.Bundle.SELECTDATE_TOTAL_NIGHT, String.valueOf((size - 1) >= 0 ? (size - 1) : 0));
//                bundle.putInt(IConst.Bundle.WIN_RESULT, IConst.Bundle.WIN_SELECT_DATE);
//                Intent intent = new Intent();
//                intent.putExtras(bundle);
//                return intent;
...
//            } else {
//                if (Validator.isNotEmpty(getEndDateValue())) {
//
//                    if (Validator.isNotEmpty(getIsSingleDateWidget()) && IConst.BASE.DATE_SINGLE.equals(getIsSingleDateWidget())) {
//                        //是单个日期控件点触发的日期控件
...
//            }
//        } else {
//            if (Validator.isNotEmpty(getStartDateValue()) && Validator.isNotEmpty(getEndDateValue())) {
